...
#description    :This script will mount my HFS+ macOS Time Machine backup sparsebundle image.
#author         :J.D. Stone
#date           :20240627
#version        :0.1
#usage          :No usage, just run script and it will automatically mount the sparsebundle to a static directory.
#
...
## Run sudo mount IGG Time Machine command
